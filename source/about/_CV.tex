...
\begin{document}
  ...
  \\
  \\
  \cventry{November 2014 - ...}{Security Consultant}{NCCGroup}{}{}{}
...
\cvlistitem{Python: Advanced knowledge. Used for web development, dealing with binary formats, scripting as well as cpu-intensive loads, wrapping native libraries with ctypes, sketching out some proof of concept gui. I also read the internal details of some Python implementations and wrote my own simple tool to manage virtual environments}
\cvlistitem{Clojure: Used on and off since 2013, I'm comfortable with the language and the surrounding tooling.}
\cvlistitem{Haskell: Good knowledge, but never used for huge projects}
\cvlistitem{Java: Good knowledge and experience with legacy Java codebases (no tests, huge amounts of code duplication and accidental complexity).}
